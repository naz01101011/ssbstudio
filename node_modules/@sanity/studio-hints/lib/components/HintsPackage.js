...
class HintsPackage extends _react.default.PureComponent {
  ...
  componentDidMount() {
    ...
    this.subscription = _datastore.locationSetting.listen().subscribe(currentLocation => {
      this.setState({
        activePage: currentLocation ? JSON.parse(currentLocation).id : null
      });
    });
  }
  ...
  */
  ...
  render() {
    ...
    if (!hintsPackage || (0, _isEmpty2.default)(hintsPackage)) {
    ...
    }, title), /*#__PURE__*/_react.default.createElement(_LinksList.default, {
      title: linksTitle,
      links: links,
      repoId: repoId
    }), /*#__PURE__*/_react.default.createElement(_LinksList.default, {
      type: "card",
      title: hintsTitle,
      links: hints,
      repoId: repoId
    ...
    }, sidebarRemovalInstructions && /*#__PURE__*/_react.default.createElement("a", {
      href: (0, _utils.resolveUrl)(sidebarRemovalInstructions),
      className: _HintsPackage.default.removeHintsLink,
      target: "_blank",
