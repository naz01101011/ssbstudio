...
<html lang="en">
<head>
    <title>Code coverage report for Refractor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> Refractor.js
    </h1>
    <div class='clearfix'>
...
function Refractor(props) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (process.env.NODE_ENV !== 'production') {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!fract.registered(props.language)) {
...
Refractor.hasLanguage = <span class="fstat-no" title="function not covered" >la</span>ng =&gt; <span class="cstat-no" title="statement not covered" >fract.registered(lang)</span>
&nbsp;
